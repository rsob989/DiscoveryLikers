			...
			<div class="container">
				<div class="row bs-callout bs-callout-primary">
					<div class="col col-md-1 col-sm-2">
						...
						<a href="${pageContext.request.contextPath}/vote?discovery_id=${discovery.id}&vote=VOTE_DOWN" class="btn btn-block btn-primary btn-danger">
					...
					<div class="col col-md-11 col-sm-10">
						...
						Date: <fmt:formatDate value="${discovery.timestamp}" pattern="dd/MM/YYYY"/></small></h6>
   						...
   						<a href="<c:out value='${discovery.url}'/>" class="btn btn-default btn-xs">Go to page</a>
					</div>
				</div>
			</div>
		</c:forEach>
